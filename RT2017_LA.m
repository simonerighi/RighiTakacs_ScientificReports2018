function [prop_coop,prop_true_coop,tconv]=...
    RT2017_LA(N,P_Link,tmax,Prop_UD,Prop_TFT,Prop_conrec,Prop_unconrec,Prop_UC,Prop_SJ,init_C,Perr,Pfor,...
...
[Adj_LM] = Initialize_Actions_LA (Adj,N,init_C); % initalize previous actions
...
for t=2:tmax
    ...
    for ego=1:N % per tutti gli agenti
