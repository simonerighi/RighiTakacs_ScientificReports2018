...
% a population. The rest of the population is equally divided among all types
% of agents. Evolution is copy the best, tit-for-tat is of the nice type.
...
for j=1:length(Prop_TFT)
    ...
    save('NS_13_TFTEffect_NiceTFT.mat')
end
