...
% FIGURE S13 - PERFORMANCE OF INDIRECT RECIPROCITY WITH LATTICE NETWORK
...
load NS_26_URCRStudy_lattice_newlattice.mat %_long
...
% FIGURE S13 (Panel 6) - Proportion of simulation without a dominant
% strategy
fignum = figure(3);
...
tt=['LatticeInitial Proportions of UR and CR - No Dominance'];
title({'Initial Proportions of UR and CR','No Dominance'},'FontSize',18) 
fn=tt(~isspace(tt));
saveas(fignum,fn);
print('-depsc', fn);

% FIGURE S13 (Panel 5) - Proportion of simulation dominated by UD
fignum = figure(4);
axes1 = axes('Parent',fignum);
hold(axes1,'on');
set(axes1,'FontSize',18);
...
xlabel('Prop UR','FontSize',18);
ylabel('Prop CR','FontSize',18);
tt=['LatticeInitial Proportions of UR and CR - Proportion Dominated by UD'];
...
% FIGURE S13 (Panel 4) - Proportion of simulation dominated by UC
fignum = figure(6);
axes1 = axes('Parent',fignum);
hold(axes1,'on');
set(axes1,'FontSize',18);
...
xlabel('Prop UR','FontSize',18);
ylabel('Prop CR','FontSize',18);
tt=['LatticeInitial Proportions of UR and CR - Proportion Dominated by UC'];
title({'Initial Proportions of UR and CR','Proportion Dominated by UC'},'FontSize',18) 
fn=tt(~isspace(tt));
saveas(fignum,fn);
print('-depsc', fn);

% FIGURE S13 (Panel 3) - Proportion of simulation dominated by SJ
fignum = figure(7);
axes1 = axes('Parent',fignum);
hold(axes1,'on');
set(axes1,'FontSize',18);
...
xlabel('Prop UR','FontSize',18);
ylabel('Prop CR','FontSize',18);
tt=['LatticeInitial Proportions of UR and CR - Proportion Dominated by SJ'];
...
% FIGURE S13 (Panel 2) - Proportion of simulation dominated by UR
fignum = figure(8);
axes1 = axes('Parent',fignum);
hold(axes1,'on');
set(axes1,'FontSize',18);
...
xlabel('Prop UR','FontSize',18);
ylabel('Prop CR','FontSize',18);
tt=['LatticeInitial Proportions of UR and CR - Proportion Dominated by UR'];
title({'Initial Proportions of UR and CR','Proportion Dominated by UR'},'FontSize',18) 
fn=tt(~isspace(tt));
saveas(fignum,fn);
print('-depsc', fn);

% FIGURE S13 (Panel 1) - Proportion of simulation dominated by CR
fignum = figure(9);
axes1 = axes('Parent',fignum);
hold(axes1,'on');
set(axes1,'FontSize',18);
...
xlabel('Prop UR','FontSize',18);
ylabel('Prop CR','FontSize',18);
tt=['LatticeInitial Proportions of UR and CR - Proportion Dominated by CR'];
...
%%%%
% FIGURE S14 - PERFORMANCE OF INDIRECT RECIPROCITY WITH LATTICE NETWORK


% FIGURE S14 (left Panel) - Proportion of Cooperators 
fignum = figure(10);
axes1 = axes('Parent',fignum);
hold(axes1,'on');
box(axes1,'on');
...
% FIGURE S14 (right Panel) - Strategy dominanting most frequently
fignum=figure(11)
